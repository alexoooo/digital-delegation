...
public class UserAgentImpl implements UserAgent
{
    ...
    {
        return isPost
                ? load(url, referrer, data)
                : load(WebUtils.asUrl(
                        url.toString() + "?" + WebUtils.urlEncode(data)),
                       referrer);
    }

    public Response load(final URL    url,
                         final URL    referer,
                         final String postData)
    {
        ...
        {
            error[ 0 ] = new SocketTimeoutException(
                                "didn't finish in " +
                                    TIMOUT_SECONDS
                                + " seconds");
        }
    ...
    //--------------------------------------------------------------------
    private Response responceInstance(
            URL url, InputStream input, String type)
    {
    ...
    public class TextResponseImpl extends ResponseImpl
                                  implements TextResponse
    {
    ...
    public class ImageResponseImpl extends ResponseImpl
                                   implements ImageResponse
    {
