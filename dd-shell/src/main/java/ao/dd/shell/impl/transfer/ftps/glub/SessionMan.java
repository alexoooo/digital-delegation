...
public class SessionMan implements SSLSessionManager
{
    ...
    private static final Logger LOG =
            Logger.getLogger(SessionMan.class);
    ...
    public boolean continueWithCertificateHostMismatch(
            SSLCertificate cert, String actualHost, String certHost)
    {
    ...
    public short newCertificateEncountered(SSLCertificate cert)
    {
        ...
        str.append("New certificate found:\n")
           .append("Common Name........: ")
                .append(cert.getCN()).append("\n")
           .append("Start Date.........: ")
                .append(cert.getStartDate()).append("\n")
           .append("End Date...........: ")
                .append(cert.getEndDate()).append("\n")
           .append("Fingerprint........: ")
                .append(cert.getFingerprint()).append("\n")
           .append("Serial Number......: ")
                .append(cert.getSerialNumber()).append("\n")
           .append("Organization.......: ")
                .append(cert.getOrg()).append("\n")
           .append("Organizational Unit: ")
                .append(cert.getOU()).append("\n")
           .append("Locality...........: ")
                .append(cert.getLocality()).append("\n")
           .append("State/Province.....: ")
                .append(cert.getState()).append("\n")
           .append("Country............: ")
                .append(cert.getCountry()).append("\n")
           .append("Email..............: ")
                .append(cert.getEmail()).append("\n")
           .append("Issuer's Common Name........: ")
                .append(cert.getIssuerCN()).append("\n")
           .append("Issuer's Organization.......: ")
                .append(cert.getIssuerOrg()).append("\n")
           .append("Issuer's Organizational Unit: ")
                .append(cert.getIssuerOU()).append("\n")
           .append("Issuer's Locality...........: ")
                .append(cert.getIssuerLocality()).append("\n")
           .append("Issuer's State/Province.....: ")
                .append(cert.getIssuerState()).append("\n")
           .append("Issuer's Country............: ")
                .append(cert.getIssuerCountry()).append("\n")
           .append("Issuer's Email..............: ")
                .append(cert.getIssuerEmail()).append("\n");
    ...
    //--------------------------------------------------------------------
    // Callback method required to implement interface SSLSessionManager
    public short replaceCertificate(
            SSLCertificate oldCert, SSLCertificate newCert)
    {
